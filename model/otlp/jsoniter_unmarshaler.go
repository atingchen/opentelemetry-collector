...
// NewJSONIterTracesUnmarshaler returns a model.TracesUnmarshaler. Unmarshals from OTLP json bytes.
func NewJSONIterTracesUnmarshaler() pdata.TracesUnmarshaler {
	return newJSONIterUnmarshaler()
}

// NewJSONIterMetricsUnmarshaler returns a model.MetricsUnmarshaler. Unmarshals from OTLP json bytes.
func NewJSONIterMetricsUnmarshaler() pdata.MetricsUnmarshaler {
	return newJSONIterUnmarshaler()
}

// NewJSONIterLogsUnmarshaler returns a model.LogsUnmarshaler. Unmarshals from OTLP json bytes.
func NewJSONIterLogsUnmarshaler() pdata.LogsUnmarshaler {
	return newJSONIterUnmarshaler()
}
...
func (d *jsonIterUnmarshaler) UnmarshalTraces(buf []byte) (pdata.Traces, error) {
	...
	err := iter.Error // set error before ReturnIterator
...
func readInstrumentationLibrarySpans(iter *jsoniter.Iterator) *otlptrace.InstrumentationLibrarySpans {
	...
	iter.ReadObjectCB(func(iter *jsoniter.Iterator, f string) bool {
		...
		case "instrumentationLibrary", "instrumentation_library", "scope":
			iter.ReadObjectCB(func(iter *jsoniter.Iterator, f string) bool {
				switch f {
				case "name":
					ils.InstrumentationLibrary.Name = iter.ReadString()
				case "version":
					ils.InstrumentationLibrary.Version = iter.ReadString()
				default:
	...
	iter.ReadObjectCB(func(iter *jsoniter.Iterator, f string) bool {
		...
		case "status":
			iter.ReadObjectCB(func(iter *jsoniter.Iterator, f string) bool {
				...
				case "deprecatedCode", "deprecated_code":
					sp.Status.DeprecatedCode = readStatusDeprecatedCode(iter)
				default:
...
func readStatusDeprecatedCode(iter *jsoniter.Iterator) otlptrace.Status_DeprecatedStatusCode {
	any := iter.ReadAny()
	if v := any.ToInt(); v > 0 {
		return otlptrace.Status_DeprecatedStatusCode(v)
	}
	v := any.ToString()
	return otlptrace.Status_DeprecatedStatusCode(otlptrace.Status_DeprecatedStatusCode_value[v])
}
